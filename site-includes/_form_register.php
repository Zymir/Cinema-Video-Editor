<form class="form-horizontal" action="<?php echo getSiteUrl()?>/site-actions/user.php?action=registro" method="post">
	<fieldset>
	   ...
	   <div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="password" name="pwd2" id="user_pass" class="input-xlarge" placeholder="Contraseña" required="required"><br/><br/>
				<input type="password" name="pwd2" id="user_pass2" class="input-xlarge" placeholder="Repite tu contraseña" required="required" onfocus="validatePass(document.getElementById('user_pass'), this);" oninput="validatePass(document.getElementById('user_pass'), this);">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<label class="checkbox">
					<input type="checkbox" name="optionsCheckboxList1" value="1" required="required">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="checkbox">
					<input type="checkbox" name="optionsCheckboxList1" value="1">
